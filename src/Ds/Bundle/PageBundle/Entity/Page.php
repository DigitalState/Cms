 ...
 * @ApiResource(
 *      attributes={
 *          "filters"={"ds.page.search", "ds.page.search_translation", "ds.page.date", "ds.page.order"},
 ...
 *      }
 * )
 * @ORM\Entity(repositoryClass="Ds\Bundle\PageBundle\Repository\PageRepository")
 * @ORM\Table(name="ds_page")
